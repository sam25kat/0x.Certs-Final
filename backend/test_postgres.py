...
# Set the DATABASE_URL BEFORE importing database module
os.environ["DATABASE_URL"] = "postgresql://neondb_owner:npg_1yksRpPDbcq6@ep-ancient-flower-adtwsoft-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require"
