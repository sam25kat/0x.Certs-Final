          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-2 md:gap-3">
              ...
              <Button
                ...
                asChild
              >
                <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 md:gap-2">
                  Social Link
              ...
              <Button
                ...
                asChild
              >
                <a href="https://t.me/0xday" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 md:gap-2">
